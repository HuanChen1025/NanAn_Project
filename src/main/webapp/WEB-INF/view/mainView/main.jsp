    ...
    <body>
        <div id="wrap">
            ...
            <div class="leftMeun" id="leftMeun">
                <div id="logoDiv">
                    <p id="logoP"><img id="logo" alt="国网成效分析" src="../static/images/logo.png"><span>大数据分析平台</span></p>
                </div>
                <div class="meun-title">配电网现状分析</div>
                <div class="meun-item"><img src="../static/images/icon_source.png"><a href="gongdianquyu" target="mainframe">供电区域简介</a></div>
                <div class="meun-item"><img src="../static/images/icon_chara_grey.png"><a href="dianwanggaikuang" target="mainframe">供电区域概况</a></div>
                <div class="meun-item"><img src="../static/images/icon_chara_grey.png"><a href="wangjialianluo" target="mainframe">中压网架联络情况</a></div>
                <div class="meun-item"><img src="../static/images/icon_chara_grey.png"><a href="wangjiafenduan" target="mainframe">中压网架分段情况</a></div>
                <div class="meun-item"><img src="../static/images/icon_user_grey.png"><a href="xianlufuzai" target="mainframe">中压线路负载率</a></div>
                <div class="meun-item"><img src="../static/images/icon_user_grey.png"><a href="zhibiaogaikuang" target="mainframe">指标概况</a></div>
                <div class="meun-item"><img src="../static/images/icon_user_grey.png"><a href="bootstrapTest1" target="mainframe">成效计算公式</a></div>
                <div class="meun-title">配电网运行状态评估</div>
                ...
                <div class="meun-title">配电网运行状态风险预警</div>
